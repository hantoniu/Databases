Create Or Alter Procedure usp_RemoveForeignKeySimple As
Begin
...
set @query = N'ALTER TABLE ' + N'Nurses' + N' DROP CONSTRAINT FK_Nurses';

declare @undoQuery nvarchar(1000);
set @undoQuery = N'usp_AddForeignKeySimple';
...
Exec usp_RemoveForeignKeySimple;